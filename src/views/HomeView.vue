    ...
    <div>
      <svg width="315" height="33" viewBox="0 0 315 33" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
            ...
            fill="white"/>
        <path d="M59.4254 0L62.6198 1.31883L88.3516 30.5089C89.2016 31.476 88.5275 33 87.238 33H30.3818L59.4254 0Z"
              fill="#2044A0"/>
        <path
        ...
        <path
            ...
            fill="#28293D"/>
        <path d="M159.317 9.41185V26.4101H155.156V9.41185H149.441V5.71913H165.032V9.41185H159.317Z" fill="#28293D"/>
        <path
        ...
        <path
            ...
            fill="#28293D"/>
        <path
            d="M218.078 26.4101H214.327L206.824 13.4269V26.4101H202.663V5.71913H206.531L213.917 18.5557V5.71913H218.078V26.4101V26.4101Z"
            fill="#28293D"/>
        <path
            ...
            fill="#28293D"/>
        <path d="M248.968 9.41185V26.4101H244.806V9.41185H239.092V5.71913H254.683V9.41185H248.968Z" fill="#28293D"/>
      </svg>
    </div>
    <form
        @submit.prevent='onSubmit'
        class="p-8 bg-white rounded-xl w-[315px] mt-12">
      ...
      <div class="mt-11">
        ...
        <div class="flex flex-col mt-4">
          ...
          <div
            ...
            <input name="password" id="password" type="password" v-model="password" ref="inputPass"
                   placeholder="********"
                   minlength="8"
                   required
        ...
        <VButton label="Kirish" class="w-full flex items-center justify-center hover:cursor-pointer"
